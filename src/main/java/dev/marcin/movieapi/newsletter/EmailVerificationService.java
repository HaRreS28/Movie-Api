...
public class EmailVerificationService implements EmailSender{
    ...
    private static final String FROM="add your email";

    @Override
    @Async
    public void sendEmail(NewsletterDto newsletterDto) {
        String to = newsletterDto.getMail();
        ...
        try {
            ...
            helper.setTo(to);
            helper.setText(buildEmail(to),true);
    ...
    private String buildEmail(String name){
        return "<!doctype html>\n" +
                ...
                "                        <p style=\"font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;\">Thanks for choosing us! We will send you the best news from movies world!</p>\n" +
